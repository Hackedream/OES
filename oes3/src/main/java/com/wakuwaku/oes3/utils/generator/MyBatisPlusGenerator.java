package com.wakuwaku.oes3.utils.generator;
...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("Ania");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/oes?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("Knight@201603024");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.wakuwaku.oes3");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
